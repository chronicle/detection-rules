...
API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.dataTables.dataTableRows/delete
"""
...
def delete_data_table_row(
  ...
  Args:
    ...
    resource_name: The resource name of the data table row to delete. Format:
  ...
  for _ in range(max(max_retries, 0) + 1):
    response = http_session.request(method="DELETE", url=url)
