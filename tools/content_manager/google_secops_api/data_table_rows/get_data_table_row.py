...
#
"""Retrieve a data table row.

API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.dataTables.dataTableRows/get
"""
...
def get_data_table_row(
  ...
  """Retrieves a data table row.

  Args:
    http_session: Authorized session for HTTP requests.
    resource_name: The resource name of the data table row to retrieve. Format:
