...
#
"""Unit tests for the "get_data_table_row" module."""

import unittest
from unittest import mock

from google.auth.transport import requests
from google_secops_api.data_table_rows.get_data_table_row import get_data_table_row
...
class CreateDataTableRowTest(unittest.TestCase):
  ...
  def test_http_ok(
    ...
    actual_data_table_row = get_data_table_row(
        http_session=mock_session,
