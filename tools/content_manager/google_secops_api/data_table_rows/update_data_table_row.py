...
#
"""Update an existing data table row.

API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.dataTables.dataTableRows/patch
"""
...
def update_data_table_row(
  ...
  """Updates an existing data table row.

  Args:
    http_session: Authorized session for HTTP requests.
    resource_name: The resource name of the data table row to update. Format:
      projects/{project}/locations/{location}/instances/{instance}/dataTables/{data_table_name}/dataTableRows/{data_table_row}
    updates: A dictionary containing the updates to make to the data table
      Example - A value of {"values": ["user1", "desktop1"]} will update the
      column values for the data table row accordingly.
    update_mask (optional): The list of fields to update for the data table. If
      ...
      Example - An update_mask of ["values"] will update the column values for
