...
API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.dataTables.dataTableRows/bulkReplace
"""
...
def bulk_replace_data_table_rows(
  ...
  Raises:
    ...
    JSON.
  """
  url = f"{os.environ['GOOGLE_SECOPS_API_BASE_URL']}/{resource_name}/dataTableRows:bulkReplace"

  # Populate a list of data table row requests. Reference: https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.dataTables.dataTableRows/bulkCreate#CreateDataTableRowRequest
