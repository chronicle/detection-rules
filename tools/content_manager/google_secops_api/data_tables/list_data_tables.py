...
#
"""Retrieve a list of data tables.

API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.dataTables/list
"""
...
def list_data_tables(
  ...
  Args:
    ...
    page_size (optional): Maximum number of data tables to return. Must be
    ...
    page_token (optional): Page token from a previous ListDataTables call used
      for pagination.
    order_by (optional): Configures the ordering of the DataTables in the
  ...
  Returns:
    List of data tables and a page token for the next page of data tables, if
    there are any.
  ...
  return response_json.get("dataTables"), response_json.get("nextPageToken")
