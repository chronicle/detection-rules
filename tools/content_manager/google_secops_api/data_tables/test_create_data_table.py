...
#
"""Unit tests for the "create_data_table" module."""

import unittest
from unittest import mock

from google.auth.transport import requests
from google_secops_api.data_tables.create_data_table import create_data_table


class CreateDataTableTest(unittest.TestCase):
  """Unit tests for the "create_data_table" module."""
  ...
  def test_http_error(
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      create_data_table(
          ...
          column_info=[
              {"column_index": 0, "column_type": "STRING", "original_column": "userid"},
              {
                  "column_index": 1,
                  "column_type": "STRING",
  ...
  def test_http_ok(
    ...
    expected_data_table = {
        "name": "projects/1234567891234/locations/us/instances/3f0ac524-5ae1-4bfd-b86d-53afc953e7e6/dataTables/data_table_1",
    ...
    actual_data_table = create_data_table(
        http_session=mock_session,
        name="data_table_1",
        description="data table description",
        column_info=[
    ...
    self.assertEqual(actual_data_table, expected_data_table)
