...
#
"""Unit tests for the "get_data_table" module."""

import unittest
from unittest import mock

from google.auth.transport import requests
from google_secops_api.data_tables.get_data_table import get_data_table
...
class GetDataTableTest(unittest.TestCase):
  ...
  def test_http_ok(
    ...
    response = get_data_table(
        http_session=mock_session,
        resource_name="projects/1234567891234/locations/us/instances/3f0ac524-5ae1-4bfd-b86d-53afc953e7e6/dataTables/data_table_1",
    )
    self.assertEqual(response, expected_data_table)
