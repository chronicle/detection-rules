...
#
"""Retrieve a single findings refinement.

API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.findingsRefinements/get
"""
...
def get_findings_refinement(
  ...
  """Retrieves a single findings refinement.

  Args:
    http_session: Authorized session for HTTP requests.
    resource_name: The resource name of the findings refinement to retrieve.
      Format -
  ...
  Returns:
    Content and metadata about the findings refinement. e.g. A set of logic
    conditions used to refine various types of
    findings such as curated detections. Reference:
