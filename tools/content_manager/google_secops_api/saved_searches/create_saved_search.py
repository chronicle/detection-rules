...
def create_saved_search(
  ...
  Args:
    ...
    query: The query for the saved search. Reference -
      https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.users.searchQueries#SearchQuery
    description (optional): A user-provided description of the saved search.
    sharing_mode (optional): The sharing mode for the saved search. Reference -
      https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.users.searchQueries#SharingMode
    placeholder_names (optional): A list of names for the query placeholders to
      be shown in the UI. Each element's position corresponds to the
      description in the placeholder_descriptions field.
    placeholder_descriptions (optional): A list of descriptions for the query
      placeholders to be shown in the UI. Each element's position corresponds
