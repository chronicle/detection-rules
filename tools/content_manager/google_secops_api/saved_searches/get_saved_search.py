...
def get_saved_search(
  ...
  Args:
    ...
    resource_name: The resource name of the saved search to retrieve. Format:
      projects/{project}/locations/{location}/instances/{instance}/users/{user}/searchQueries/{saved_search_id}
  ...
  Returns:
    Content and metadata about the requested saved search.
