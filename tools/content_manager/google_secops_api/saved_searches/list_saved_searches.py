...
#
"""Retrieve a list of saved searches for the current user.

API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.users.searchQueries/list
"""
...
def list_saved_searches(
  ...
  Args:
    ...
    page_size (optional): Maximum number of saved searches to return. Must be
    ...
    page_token (optional): Page token from a previous call used for pagination.
      The first page is retrieved if the token is the empty string
      or a None value.
  ...
  Returns:
    List of saved searches and a page token for the next page of saved searches,
    if there are any.
  ...
  return response_json.get("searchQueries"), response_json.get("nextPageToken")
