...
#
"""Unit tests for the "create_saved_search" module."""
...
class CreateSavedSearchTest(unittest.TestCase):
  """Unit tests for the "create_saved_search" module."""
  ...
  def test_http_ok(
    ...
    actual_saved_search = create_saved_search(
        http_session=mock_session,
        name="Windows Login Events",
        description="Windows login events",
        query=(
    ...
    self.assertEqual(actual_saved_search, expected_saved_search)
