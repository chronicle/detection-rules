...
#
"""Retrieve the deployment state for a findings refinement.

API reference:
https://cloud.google.com/chronicle/docs/reference/rest/v1alpha/projects.locations.instances.findingsRefinements/getDeployment
"""
